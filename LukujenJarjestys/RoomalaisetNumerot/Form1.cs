...
namespace RoomalaisetNumerot
{
    public partial class RoomalaisetFM : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string vastaus = "";
            if(lukuTB.Text.Length > 3)
            {
                luku1 = int.Parse(lukuTB.Text.Substring(0, 1));
                luku2 = int.Parse(lukuTB.Text.Substring(1, 1));
                luku3 = int.Parse(lukuTB.Text.Substring(2, 1));
                luku4 = int.Parse(lukuTB.Text.Substring(3, 1));
