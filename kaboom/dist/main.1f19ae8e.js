...
var Nt = (i, t, l) => t in i ? jt(i, t, {
  ...
  P = (i, t) => {
    for (var l in t || (t = {})) zi.call(t, l) && Nt(i, l, t[l]);
    if (sr) for (var l of sr(t)) Ji.call(t, l) && Nt(i, l, t[l]);
    return i;
  },
  D = (i, t) => Ki(i, Hi(t)),
  a = (i, t) => jt(i, "name", {
...
function Yt(i, t) {
  ...
  if (l === "object" && w === "object") {
    ...
    for (let S of U) {
      let A = i[S],
        q = t[S];
      if (!(typeof A == "function" && typeof q == "function") && !Yt(A, q)) return !1;
    }
    return !0;
  }
  return i === t;
...
var fe = a((i, t, l) => new xe(i, t, l), "vec3"),
  le = class {
    ...
    static fromHSL(t, l, w) {
      ...
      let U = a((j, X, $) => ($ < 0 && ($ += 1), $ > 1 && ($ -= 1), $ < 1 / 6 ? j + (X - j) * 6 * $ : $ < 1 / 2 ? X : $ < 2 / 3 ? j + (X - j) * (2 / 3 - $) * 6 : j), "hue2rgb"),
        p = w < .5 ? w * (1 + l) : w + l - w * l,
        S = 2 * w - p,
        A = U(S, p, t + 1 / 3),
        q = U(S, p, t),
...
var R = class {
  ...
  invert() {
    ...
    for (let We = 0; We < 4; We++) for (let Me = 0; Me < 4; Me++) t[We * 4 + Me] *= 1 / Et;
    return new R(t);
  }
  toString() {
...
var es = 1103515245,
  ...
  pe = class {
    ...
    gen(...t) {
      if (t.length === 0) return this.seed = (es * this.seed + ts) % hr, this.seed / hr;
      if (t.length === 1) {
...
a(he, "testLineLine");
function ft(i, t) {
  return ue(i, t.p1) || ue(i, t.p2) ? !0 : !!he(t, new ae(i.p1, f(i.p2.x, i.p1.y))) || !!he(t, new ae(f(i.p2.x, i.p1.y), i.p2)) || !!he(t, new ae(i.p2, f(i.p1.x, i.p2.y))) || !!he(t, new ae(f(i.p1.x, i.p2.y), i.p1));
}
a(ft, "testRectLine");
function ue(i, t) {
...
var qr = {
  ...
  Pr = ["left", "middle", "right", "back", "forward"],
  ds = ["space", "left", "right", "up", "down", "tab", "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "s"],
  Dr = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~",
  fs = " \u263A\u263B\u2665\u2666\u2663\u2660\u2022\u25D8\u25CB\u25D9\u2642\u2640\u266A\u266B\u263C\u25BA\u25C4\u2195\u203C\xB6\xA7\u25AC\u21A8\u2191\u2193\u2192\u2190\u221F\u2194\u25B2\u25BC !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~\u2302\xC7\xFC\xE9\xE2\xE4\xE0\xE5\xE7\xEA\xEB\xE8\xEF\xEE\xEC\xC4\xC5\xC9\xE6\xC6\xF4\xF6\xF2\xFB\xF9\xFF\xD6\xDC\xA2\xA3\xA5\u20A7\u0192\xE1\xED\xF3\xFA\xF1\xD1\xAA\xBA\xBF\u2310\xAC\xBD\xBC\xA1\xAB\xBB\u2591\u2592\u2593\u2502\u2524\u2561\u2562\u2556\u2555\u2563\u2551\u2557\u255D\u255C\u255B\u2510\u2514\u2534\u252C\u251C\u2500\u253C\u255E\u255F\u255A\u2554\u2569\u2566\u2560\u2550\u256C\u2567\u2568\u2564\u2565\u2559\u2558\u2552\u2553\u256B\u256A\u2518\u250C\u2588\u2584\u258C\u2590\u2580\u03B1\xDF\u0393\u03C0\u03A3\u03C3\xB5\u03C4\u03A6\u0398\u03A9\u03B4\u221E\u03C6\u03B5\u2229\u2261\xB1\u2265\u2264\u2320\u2321\xF7\u2248\xB0\u2219\xB7\u221A\u207F\xB2\u25A0",
  Ar = 0,
  Or = 3,
  ps = 0,
  ms = 3,
...
`,
  xs = new Set(["id", "require"]),
  vs = new Set(["add", "load", "update", "draw", "destroy", "inspect"]);
function kr(i) {
...
var ao = a((i = {}) => {
  let t = (() => {
    ...
    l = (() => {
      ...
      let e = t.gl,
        n = hn(an, un),
        r = He(new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)),
      ...
      e.bindBuffer(e.ARRAY_BUFFER, c), e.vertexAttribPointer(0, 3, e.FLOAT, !1, Ye * 4, 0), e.enableVertexAttribArray(0), e.vertexAttribPointer(1, 2, e.FLOAT, !1, Ye * 4, 12), e.enableVertexAttribArray(1), e.vertexAttribPointer(2, 4, e.FLOAT, !1, Ye * 4, 20), e.enableVertexAttribArray(2), e.bufferData(e.ARRAY_BUFFER, bt * 4, e.DYNAMIC_DRAW), e.bindBuffer(e.ARRAY_BUFFER, null);
      ...
      let o = He(new ImageData(new Uint8ClampedArray([128, 128, 128, 255, 190, 190, 190, 255, 190, 190, 190, 255, 128, 128, 128, 255]), 2, 2), {
        wrap: "repeat",
        filter: "nearest"
      });
      return {
  ...
  function Se(e = 1, n = 1, r = 0, u = 0, c = 1, s = 1) {
    let o = [],
      d = c / e,
      h = s / n;
    for (let m = 0; m < n; m++) for (let g = 0; g < e; g++) o.push(new V(r + g * d, u + m * h, d, h));
    return o;
  }
  a(Se, "slice");
  function Ce(e, n) {
    return S(typeof n == "string" ? k(n).then(r => r.json()).then(r => Ce(e, r)) : J(null, e).then(r => {
      ...
      for (let o in n) {
        let d = n[o],
          h = {
            tex: r.tex,
            frames: Se(d.sliceX, d.sliceY, d.x / c, d.y / s, d.width / c, d.height / s),
            anims: d.anims
          };
        U.sprites[o] = h, u[o] = h;
      }
  ...
  function hn(e = an, n = un) {
    let r = t.gl,
      u,
      c = ys.replace("{{user}}", e != null ? e : an),
      s = bs.replace("{{user}}", n != null ? n : un),
...
`) throw new Error(u);
    return {
      ...
      send(m) {
        ...
        for (let g in m) {
          ...
          typeof y == "number" ? r.uniform1f(x, y) : y instanceof R ? r.uniformMatrix4fv(x, !1, new Float32Array(y.m)) : y instanceof v ? r.uniform4f(x, y.r, y.g, y.b, y.a) : y instanceof xe ? r.uniform3f(x, y.x, y.y, y.z) : y instanceof L && r.uniform2f(x, y.x, y.y);
        }
        this.unbind();
      }
    };
  ...
  a(dn, "flush");
  function ze() {
    t.gl.clear(t.gl.COLOR_BUFFER_BIT), i.background || me({
      width: F(),
      height: G(),
      quad: new V(0, 0, F() * t.scale / Vr, G() * t.scale / Vr),
      tex: l.bgTex,
      fixed: !0
  ...
  function me(e) {
    ...
    let n = e.width,
      r = e.height,
      c = $e(e.origin || je).scale(f(n, r).scale(-.5)),
      s = e.quad || new V(0, 0, 1, 1),
      o = e.color || E(255, 255, 255),
      d = (h = e.opacity) != null ? h : 1;
    re(), I(e.pos), Qe(e.angle), ne(e.scale), I(c), Tt([{
      pos: fe(-n / 2, r / 2, 0),
  ...
  function jr(e) {
    ...
    if (e.tiled) {
      let o = Math.ceil((e.width || r) / r),
        ...
        m = $e(e.origin || je).add(f(1, 1)).scale(.5).scale(o * r, d * u);
      for (let g = 0; g < o; g++) for (let y = 0; y < d; y++) me(D(P({}, e), {
    ...
    } else e.width && e.height ? (c.x = e.width / r, c.y = e.height / u) : e.width ? (c.x = e.width / r, c.y = c.x) : e.height && (c.y = e.height / u, c.x = c.y), me(D(P({}, e), {
      scale: c.scale(e.scale || f(1)),
      tex: e.tex,
      quad: n,
      width: r,
  ...
  function Q(e) {
    ...
    let n = e.width,
      r = e.height,
      c = $e(e.origin || je).add(1, 1).scale(f(n, r).scale(-.5)),
  ...
  function pn(e) {
    ...
    } else for (let r = 0; r < n.length - 1; r++) qe(D(P({}, e), {
      p1: n[r],
      p2: n[r + 1]
    }));
  }
  ...
  function wn(e) {
    ...
    e.radiusX === 0 || e.radiusY === 0 || Ze(D(P({}, e), {
      pts: Le(f(0), e.radiusX, e.radiusY, (n = e.start) != null ? n : 0, (r = e.end) != null ? r : 360, e.resolution),
      radius: 0
    }));
  }
  a(wn, "drawEllipse");
  function Ze(e) {
    ...
    let n = e.pts.length;
    if (!(n < 3)) {
      if (re(), I(e.pos), ne(e.scale), Qe(e.angle), I(e.offset), e.fill !== !1) {
...
` && (M.push(oe), y += m, oe === " " && (ee = M.length)), W = Math.max(W, y), te++;
    ...
    let Ve = [],
      ke = f(e.pos || 0),
      _ = $e(e.origin || je).scale(.5),
      se = -_.x * m - (_.x + .5) * (W - m),
      Fe = -_.y * g - (_.y + .5) * (x - g),
      ct = 0;
    return O.forEach((oe, _i) => {
      let Bi = (W - oe.length * m) * (_.x + .5);
      oe.forEach((lt, Ni) => {
        var rr;
        let Gt = n.map[lt],
          ji = Ni * m,
        ...
        if (Gt) {
          let _t = {
            tex: n.tex,
            quad: new V(Gt.x, Gt.y, n.qw, n.qh),
            ch: lt,
            pos: f(ke.x + ji + se + Bi, ke.y + Yi + Fe),
            opacity: e.opacity,
          ...
          if (r[ct]) {
            ...
            for (let Xi of ht) {
              let Bt = e.styles[Xi],
                ir = typeof Bt == "function" ? Bt($i, lt) : Bt;
              ir && gn(_t, ir);
            }
          }
          Ve.push(_t);
  ...
  a(G, "height"), t.canvas.addEventListener("mousemove", e => {
    ...
    ds.includes(n) && e.preventDefault(), n.length === 1 && t.charInputted.push(e.key), n === "space" && t.charInputted.push(" "), e.repeat ? (t.isKeyPressedRepeat = !0, t.keyStates[n] = "rpressed") : (t.isKeyPressed = !0, t.keyStates[n] = "pressed");
  ...
  a(Sn, "make");
  function Ae(e, n, r) {
    return p.objEvents[e] || (p.objEvents[e] = new Y()), p.objEvents[e].pushd({
      tag: n,
      cb: r
    });
  }
  ...
  function H(e, n) {
    if (Array.isArray(e)) {
      let r = e.map(u => H(u, n));
      return () => r.forEach(u => u());
    } else return typeof e == "function" ? p.on("input", () => De() && e()) : p.on("input", () => De(e) && n());
  }
  a(H, "onKeyPress");
  function Pt(e, n) {
    if (Array.isArray(e)) {
      ...
      return () => r.forEach(u => u());
    } else return typeof e == "function" ? p.on("input", () => De() && e()) : p.on("input", () => Wt(e) && n());
  }
  ...
  function Dt(e, n) {
    if (Array.isArray(e)) {
      ...
      return () => r.forEach(u => u());
    } else return typeof e == "function" ? p.on("input", () => nt() && e()) : p.on("input", () => nt(e) && n());
  }
  a(Dt, "onKeyRelease");
  function qn(e, n) {
  ...
  function kn() {
    H("f1", () => {
      ...
      C.timeScale = Ue(z(C.timeScale - .2, 0, 2), 1);
    }), H("f9", () => {
      C.timeScale = Ue(z(C.timeScale + .2, 0, 2), 1);
    }), H("f10", () => {
      C.stepFrame();
    ...
    return {
      ...
      moveBy(...n) {
        ...
        if (this.solid && ((o = this.area) == null ? void 0 : o.shape) === "rect") {
          ...
          p.root.every(h => {
            var ke;
            if (!this.exists() || h === this || !h.solid || ((ke = h.area) == null ? void 0 : ke.shape) !== "rect") return;
            let m = h.worldArea(),
              g = yt(m, d);
            if (ue(g, f(0))) {
  ...
  function bi(e = {}) {
    ...
    return {
      id: "body",
      require: ["pos", "area"],
      jumpForce: (s = e.jumpForce) != null ? s : Ui,
  ...
  function Wi(e, ...n) {
    ...
    let r = p.on("updateStart", () => {
      ...
      }), p.root.clearEvents(), p.timers = new Y(), p.cam = {
        pos: at(),
        scale: f(1),
        angle: 0,
        shake: 0,
        transform: new R()
      }, p.layers = {}, p.defLayer = null, p.gravity = Ir, p.scenes[e](...n), i.debug !== !1 && kn(), i.burp && Fn(), r();
    });
  }
  a(Wi, "go");
  function Mi(e, n) {
  ...
  function ki(e, n = {}) {
    ...
    let r = (n.speed || 1) * 5,
      u = n.scale || 1,
      c = Ft([st(e), Vt(Hn), ot(0), kt(), Ot("center"), Xn(r, u), ...((o = n.boomComps) != null ? o : () => [])()]),
      s = Ft([st(e), Vt(Kn), ot(0), kt(), Ot("center"), Bn(.4 / r, () => s.use(Xn(r, u))), ...((d = n.kaComps) != null ? d : () => [])()]);
    return {
      destroy() {
        ut(s), ut(c);
      }
  ...
  function Fi() {
    let e = p.cam,
      n = L.fromAngle(Be(0, 360)).scale(e.shake);
...
`),
  ...
  a(Qn, "drawDebug"), i.debug !== !1 && kn(), i.burp && Fn(), window.addEventListener("error", e => {
  ...
  a(Zn, "run"), Zn(() => {
    bn(), t.loaded ? (p.trigger("input"), C.paused || zn(), ze(), Fi(), i.debug !== !1 && Qn(), Je()) : (ze(), Gi(), Je());
  ...
  if (i.plugins && i.plugins.forEach(jn), i.global !== !1) for (let e in be) window[e] = be[e];
  return be;
}, "default");
exports.default = ao;
